<template>
  <div id="app">
    <LineChart v-bind:props="classMishaLineChartPriceExample"></LineChart>
    <!--<Legend v-bind:props="classMishaLegendPriceExample"></Legend>-->

    <piechart v-bind:props="pieConfig"></piechart>
    <BarChart></BarChart>
  </div>
</template>
...
<script>
  ...
  export default {
    components: {LineChart, Legend, piechart, BarChart},
    data: function () {
      return {
        pieConfig: {
        ...
        classMishaLineChartPriceExample: {
          serverConfig: 'configs/rs_config.json',
          width: 300,
          height: 200,
          dataXPath: "date",
          lineVis: true,
